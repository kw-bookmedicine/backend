...
public class KeywordController {
    ...
    public BookKeywordDTO getBookKeyword(@RequestParam(name = "isbn") String isbn) {
        return keywordService.getBookKeywords(isbn);
    }
    ...
    public ClientKeywordDTO getClientKeyword(@RequestParam(name = "id") Long id){
        return keywordService.getClientKeywords(id);
    }
