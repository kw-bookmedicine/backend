...
public interface FeedRepository extends JpaRepository<Feed, Long> {
    ...
    List<Feed> findByClientId(@Param("clientId") Long clientId);
    ...
    List<Feed> findRatedFeedsByClientId(@Param("clientId") Long clientId);
    ...
    Page<Feed> findPagingByClientId(@Param("clientId") Long clientId, Pageable pageable);
    ...
    Page<Feed> findRatedFeedsPagingByClientId(@Param("clientId") Long clientId, Pageable pageable);
